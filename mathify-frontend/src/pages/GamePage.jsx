...
// export default function GamePage({ user, onProfile, onLogout,onLeaderboard,onBlitz }) {
...
//             {/* we will create a game component which will have two games option one survival and other will lead to this logic */}
...
export default function GamePage({ user, onProfile, onLogout, onLeaderboard, onLobby }) {
    ...
    return (
        // ← flex row so Navbar sits on the left as a sidebar
